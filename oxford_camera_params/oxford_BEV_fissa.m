...
% Regione di interesse in metri nella BEV
% Rettangolo di lato x 14 metri e lato y 23 metri
ROI_limits = [5 0; 5 14; 28 14; 28 0; 5 0];
%% =================================================
% Trasformazione ROI -> punti nell'immagine
% Istanzio una matrice vuota per i punti dell'immagine
pts_camera = [];
